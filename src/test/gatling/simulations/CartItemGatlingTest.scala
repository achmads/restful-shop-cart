...
/**
 * Performance test for the CartItem entity.
 */
class CartItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CartItem entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created cartItem")
                .get("${new_cartItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created cartItem")
            .delete("${new_cartItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
